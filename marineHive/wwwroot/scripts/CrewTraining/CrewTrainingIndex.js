...
$(document).ready(function () {
    ...
    $('#CrewTrainingList').DataTable({
        ...
        columnDefs: [
            ...
            { width: "20%", "targets": 2, className: 'dt-body-center', "orderable": false },
...
function getDataTable() {
    $('#photoList').DataTable({
        ...
        columnDefs: [
            { width: "20%", "targets": 0, className: 'dt-body-center', "orderable": true },
            { width: "30%", "targets": 1, className: 'dt-body-center', "orderable": true },
...
function DeleteTraining(id) {
    ...
    $.ajax({
        url: '/Crewtraining/CrewTrainingDelete' + '/' + id,
        type: 'Get',
        //data: formData,
        //datatype: 'json',
